    ...
    <div class="main-content">
        ...
        <div class="slider-block">
            <div class="left-slider-block">
                <?php $block = module_invoke('superfish', 'block_view','2'); print render($block['content']); ?>
            </div>
            <div class="content-slider-block">
                <?php $block = module_invoke('views', 'block_view', 'slider_homepage-block_1'); print render($block['content']); ?>
                <?php $block = module_invoke('views', 'block_view', 'slider_homepage-block_2'); print render($block['content']); ?>
            </div>
        </div>
